  ...
  return (
    <div id="about">
      ...
      <section className="flex md:hidden section-container flex-col px-4 py-10">
        <h2 className="section-title text-[27px] text-left mb-6 pb-2">Who Am I?</h2>
        <div className="flex flex-col gap-8 items-center w-full">
          <div className="w-full text-[13.5px] mb-8 w-full font-medium text-brutal-text dark:text-dark-text leading-relaxed">
            <p className="mb-4">
              Hi, I am Dineth Nethsara Peiris. I live in Kalutara. Currently, I am following the BSc. (Hons) in Computer Science degree programme from the University of Bedfordshire (UK).
              Previously, I completed a HND in Information Technology from SLIIT CITY UNI. Currently, I am seeking an internship opportunity to secure an entry into the software industry.
            </p>
            ...
            <button
              ...
              className="font-bold underline mb-4 text-gray-600 dark:text-gray-400 active:text-black dark:active:text-white transition-colors"
            >
              {isExpanded ? 'View Less' : 'View More'}
            </button>
          </div>
          <div className="flex flex-col gap-4 w-full max-w-[300px]">
            <div className="brutal-input brutal-shadow-card flex flex-col items-center justify-center py-[18px] active:bg-[#82d2f7] group">
              <span className="font-mono text-[27px] font-bold group-active:text-black leading-none mb-2">3+</span>
              <span className="font-semibold uppercase text-[10.5px] group-active:text-black">Years Exp</span>
            </div>
            <div className="brutal-input brutal-shadow-card flex flex-col items-center justify-center py-[18px] active:bg-[#aeffda] group">
              <span className="font-mono text-[27px] font-bold group-active:text-black leading-none mb-2">10+</span>
              <span className="font-semibold uppercase text-[10.5px] group-active:text-black">Projects</span>
            </div>
            <div className="brutal-input brutal-shadow-card flex flex-col items-center justify-center py-[18px] active:bg-[#e693cb] group">
              <span className="font-mono text-[27px] font-bold group-active:text-black leading-none mb-2">100%</span>
              <span className="font-semibold uppercase text-[10.5px] group-active:text-black">Coffee</span>
            </div>
          </div>
        </div>
      </section>
